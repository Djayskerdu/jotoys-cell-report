...
// True for the row that IS this network's own boys/girls leader (e.g. Emerson P.
// Patal's own row, which — like any other root-level leader — has a blank ParentID).
// That person is a Network Leader, not a Lifegroup Leader, so this keeps them out of
    ...
    <div className="home-wrap">
      ...
      <div className="stats">
        {[
          ...
          {n: leaders.length - countOwnNetworkLeaderRows(leaders), l:"Lifegroup leaders"},
